export const es = {
  ...
  sync: {
    sincronizacion: {
      ...
      kicker: 'Cambios sin sincronizar',
      heading: 'CONFLICTOS',
    },
    invite: {
      pageTitle: 'Conectar',
    ...
    banner: {
      conflictSingular: 'conflicto',
      conflictPlural: 'conflictos',
      reviewSuffix: '— revisar',
      pendingSingular: 'cambio pendiente',
      pendingPlural: 'cambios pendientes',
      syncSuffix: 'de sincronizar',
    },
    conflictResolution: {
      typeLabels: {
      ...
      mineNoLongerExists: 'este entrenamiento ya no existe en el servidor',
      theirsNoLongerExists: 'Ya no existe en el servidor.',
      mineLabel: 'Vos:',
      serverLabel: 'Servidor:',
      keepMine: 'Mantener el mío',
      discardUseServer: 'Descartar y usar el del servidor',
      discardMine: 'Descartar mi cambio',
      discardError: 'No se pudo descartar el cambio.',
      applyError: 'No se pudo aplicar el cambio.',
      loading: 'Cargando...',
      empty: 'No hay conflictos pendientes.',
    },
    installPrompt: {
      cardTitle: 'Instalar SelfGains',
      iosPrefix: 'Tocá',
      iosShare: 'Compartir',
      iosMiddle: 'y después',
      iosAddHome: '"Agregar a inicio"',
